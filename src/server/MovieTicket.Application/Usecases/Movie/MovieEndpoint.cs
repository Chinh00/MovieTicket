using AutoMapper;
using MediatR;
using MovieTicket.Application.Usecases.Movie.Specs;
...
{
    private readonly IRepository<Domain.Entities.Movie> _repository;
    private readonly IRepository<Category> _repositoryCategory;
    private readonly IGridRepository<Domain.Entities.Movie> _gridRepository;
    private readonly IMapper _mapper;
    public MovieEndpoint(IRepository<Domain.Entities.Movie> repository, IRepository<Category> repositoryCategory, IGridRepository<Domain.Entities.Movie> gridRepository, IMapper mapper)
    {
