...
using MovieTicketClient.Application.Usecases.Screening.Specs;

namespace MovieTicketClient.Application.Usecases.Screening;
...
public class ScreeningEndpoint : IRequestHandler<ScreeningCreate.Command, ResultModel<ScreeningDto>>, IRequestHandler<GetScreenings.Query, ResultModel<ListResultModel<ScreeningDto>>>
{
    ...
    public ScreeningEndpoint(IRepository<MovieTicket.Domain.Entities.Screening> repository, IMapper mapper, IGridRepository<MovieTicket.Domain.Entities.Screening> gridRepository)
    {
