...
namespace MovieTicket.Infrastructure.EfCore
{
    ...
    public class Repository<TEntity> : RepositoryBase<AppBaseContext, TEntity> where TEntity : EntityBase
    {
        public Repository(AppBaseContext dbContext) : base(dbContext)
        {
        }
    }
 }
